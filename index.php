		...
		<table class="table table-bordered table-stripped" style="width:100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="update.php?LKod=<?=$item[0]?>">Оновити</a>
				</td
				><td>
						<a href="cars/delete.php?LKod=<?=$item[0]?>" onclick="return confirmSpelll();">Видалити</a>
				</td>
				<?php
				}
				?>
			 ...
			 <hr></hr>
			 <h2 class="text-center text-success">Додати нове авто</h2>
			 <div >
				<form action="cars/createCar.php" method="post" enctype="multipart/form-data">
				<p>Марка авто</p>
				<input class="form-control p-1" style="width:100%" type="text" name="LName">
				<p>Модель авто</p>
				<input class="form-control p-1" style="width:100%" type="text" name="LModel">
				<p>Ціна авто</p>
				<input class="form-control p-1" style="width:100%" type="number" name="LPrice">
				<p>Країна-виробник</p>
				<select class="form-control" style="width:100%"  name="LCountry">
					<option disabled value="Оберіть країну зі списку">Оберіть країну зі списку</option>
				...
				<p>Ціна авто</p>
				<input class="form-control p-1" style="width:100%" type="number" name="LPrice">
				<p>Рік випуску авто</p>
				<input class="form-control p-1" style="width:100%" type="number" name="LYear">
				<p>Дата надходження</p>
				<input class="form-control p-1" style="width:100%" type="date" name="LDataPostup">
				<label for="client">Оберіть замовника</label>
        <?php
                                        $query_group = mysqli_query($linc, "SELECT * FROM Client");
                                        echo  '<select class="form-control" name="LClientPrizv" id="client" size="5" style="color:#0c0e0c;"';
                                        echo '<option value="CKod"></option>';
                                        while ($temp = mysqli_fetch_assoc($query_group))
                                        {
                                        echo '<option style="color:#0c0e0c;" value='.$temp['CKod'].'>'.$temp['CPrizv'].'</option>';
                                        }
                                        echo "</select>";
                                    ?>
									<label>Виберіть файл для основного зображення</label>
									<div>
										<input type="hidden" name="MAX_FILE_SIZE" value="5000000"></input>
										<input type="file" name="my_file_one[]"></input>
									</div>
								<label>Виберіть файли для галереї зображень</label>
									<div>
										<input type="hidden" name="MAX_FILE_SIZE" value="5000000"></input>
										<input type="file" name="my_files[]" multiple></input>
									</div>
				
				<button name="submit_add_car" type="submit" class="btn btn-success mt-3 text-center">Додати запис в таблицю</button>
				</form>
			</div>
